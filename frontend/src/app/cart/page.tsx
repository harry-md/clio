...
export default function CartPage() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      setError(
        getApiErrorMessage(requestError, "Không thể tạo phiên thanh toán."),
      );
      setPurchasing(false);
    }
  };
                  ...
                  <li key={book.id} className="flex items-start gap-6 py-7">
                    ...
                    >
                      {book.thumbnail ? (
                        ...
                        <span className="grid h-full place-items-center px-3 text-center text-sm text-muted-foreground">
                          Clio edition
                        </span>
                      )}
                    </Link>
